...
/* Name of package */
#define PACKAGE "dlvhex-sparqlplugin"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "e.paissios@gmail.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dlvhex-sparqlplugin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dlvhex-sparqlplugin 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dlvhex-sparqlplugin"
...
/* Version number of SPARQLPLUGIN */
#define SPARQLPLUGIN_VERSION 2.0.0

/* Major version number of SPARQLPLUGIN */
#define SPARQLPLUGIN_VERSION_MAJOR 2

/* Micro version number of SPARQLPLUGIN */
#define SPARQLPLUGIN_VERSION_MICRO 0

/* Minor version number of SPARQLPLUGIN */
#define SPARQLPLUGIN_VERSION_MINOR 0
